...
export class CreateProposal1605954168177 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `proposal` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(255) NOT NULL, `saeimaUid` varchar(255) NOT NULL, `lawProjectNumber` varchar(255) NULL, `votingUid` varchar(255) NULL, `commission` varchar(255) NULL, `outcome` varchar(255) NOT NULL, `sittingId` int NULL, UNIQUE INDEX `IDX_c3eb73008365aab4b96fb98249` (`saeimaUid`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `proposal` ADD CONSTRAINT `FK_60b7b44c89afa7aab67a99f4df2` FOREIGN KEY (`sittingId`) REFERENCES `sitting`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    }
